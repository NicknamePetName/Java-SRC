...
class ManageSystemTwo{
    private final static String filename="./src/system/students.dat";
...
public class hello {
    ...
    {
       ManageSystemTwo manageSystemTwo=new ManageSystemTwo();
       manageSystemTwo.Menu();
    }
}
